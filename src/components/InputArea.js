...
function InputArea() {
    ...
    return (
        <div className='m-auto keyboardArea row  p-0 mt-2 align-items-center'>
            ...
            <div className='d-flex col-2'>
                ...
                <button className='btn btn2 px-3 border border-3 border-secondary' onClick={() => window.location.reload()} >
